...
public class UFABCGrammarLexer extends Lexer {
	...
	public static final int
		...
		ID=18, NUM=19, VIRG=20, PV=21, AP=22, FP=23, DP=24, TEXTO=25, WS=26;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "OP", "OP_AT", "OPREL", "ID", 
			"NUM", "VIRG", "PV", "AP", "FP", "DP", "TEXTO", "WS"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'text'", "'double'", "'se'", "'entao'", "'senao'", "'fimse'", "'leia'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, "OP", "OP_AT", "OPREL", "ID", "NUM", "VIRG", "PV", 
			"AP", "FP", "DP", "TEXTO", "WS"
		};
	}
